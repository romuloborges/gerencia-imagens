...
import br.ufes.gerenciaimagens.presenter.usuario.ListaUsuarioPresenter;
 ...
 * @author rborges
 */
public class TelaPrincipalUsuarioAdminState extends TelaPrincipalState {
    
    public TelaPrincipalUsuarioAdminState(PrincipalPresenter principalPresenter, Usuario usuarioLogado) {
    ...
    private void adicionaListeners() {
        ...
        view.getItemListarUsuarios().addActionListener((ae) -> {
            new ListaUsuarioPresenter(view.getDesktop(), usuarioLogado.getId());
        });
    ...
    private void removeListeners() {
        ...
        removeActionListeners(view.getItemListarUsuarios());
    ...
    protected void exibirItensSubMenus() {
        ...
        itemListarUsuarios.setVisible(true);
    }
